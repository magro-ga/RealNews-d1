...
public class LerNoticiaController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("readNoticia.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(comentarioService.adicionarComentario(comentario)) {
			...
			saida.println("Comentário Inválido<br>");
			saida.println("<a href='LerNoticia.do?id=" + idNoticia + "'>Voltar a Notícia?</a>");
		}	
	}
}
